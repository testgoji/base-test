...
16. Edit first file (named your **first name**) and do the following. 
	- > Write a program that demonstrates the use of Promises. **Prints** the numbers from 1 to 100 **and waits a full second between each iteration**. If it’s a multiple of 3, it should print “Fizz”. If it’s a multiple of 5, it should print “Buzz”. If it’s a multiple of 3 and 5, it should print “Fizz Buzz”. Accomplish this by employing any currently available means of Promise creation/use.
